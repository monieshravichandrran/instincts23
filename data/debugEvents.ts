export const debugEvents =
{
    elc: [
        {
            ...
            rules: [{ rules: ["Each debating round will consist of two teams - one to propose(for) the motion and one to oppose(against) the motion.", "3 minutes for each speaker to present their argument and 1 minute for rebuttal each.", "Preparation time will be given for each topic.", "Registration is on a first-come-first-serve basis."] }],
            date: "TBD",
        ...
        },
        {
            ...
            rules: [{ rules: ["The poems must be entirely the original work of the participant.", "Late submissions will result in a deduction of points."] }],
            date: "TBD",
            fromTime: undefined, toTime: undefined,
            venue: "TBD",
            type: "Individual",
        ...
        },
        {
            ...
            rules: [{ rules: ["Two round event.", " Round 1 is a written quiz with a time limit of 1 hour.", "Teams that clear first round enter round 2.", "Round 2 is a miscellaneous round of team games"] }],
            date: "TBD",
            fromTime: undefined, toTime: undefined,
            venue: "TBD",
            team_size: "2-3",
    ...
    },
    {
        ...
        rules: [{ rules: ["The entry fee per person is Rs.50/-", "This game event can participate as an individual as well as a team of two.", "There are three rounds and each round is an elimination round.", "Based on the scores, the team will be proceeding to the next round.", "The first round is an Auction round followed by Kahoot and Connexion is the final round."] }],
        date: "TBD",
        fromTime: undefined, toTime: undefined,
        venue: "TBD",
        type: "Lone-Wolf / Team",
    ...
    arudhra: [
        {
            ...
            description: "Arudhra (SSN-CDT) and Ameya (SNU-CDT) is proud to announce our flagship event for Instincts 2023. This is a solo dance competition for all enthusiastic classical dancers across the country. Here is your platform to showcase your flair for classical dance. Join us here for an enriching journey. ",
            date: "March 10, 2023",
            fromTime: undefined, toTime: undefined,
            venue: "TBD",
            type: "Individual",
            ...
            rules: [{
                ruleHead: "PRELIMS:",
                rules: ["Theme: Convey a story with a little jathi.",
            ...
            {
                ruleHead: "FINALE:",
                rules: ["Theme: Depiction of any Indie-filmy song",
