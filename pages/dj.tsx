        ...
        <div className="min-h-screen lg:w-[98%] sm:w-full flex flex-col items-center justify-center">
          ...
          <div className="flex justify-center mt-12 md:w-[70vw]">
            <p className="p-4 text-xl shadow-lg lg:text-2xl rounded-br-3xl">
              Release that pent up energy, let the electrifying sounds move through your veins and let loose as DJ Madhan promises a night to vibe and never forget for the rest of your lives. Catch him live on the 11th of March from 5:30pm at the Open Air Theatre.
            </p>
          </div>
