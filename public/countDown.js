...
function updateTimer() {
  ...
  if (document.getElementById("timer")) {
    document.getElementById(
      "timer"
    ).innerHTML = `<div class = "lg:h-28 lg:w-40 p-2 lg:p-4 flex lg:flex-row flex-col items-center justify-center shadow-xl border-[0.02rem] border-gray-400 border-opacity-20 bg-black/20 rounded-md lg:rounded-xl backdrop-blur-lg"><p>${d}</p><p class="text-xs lg:text-sm lg:mx-2">days</p></div>
