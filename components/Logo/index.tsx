  ...
  return (
    <>
      ...
      <div className="inline-block absolute top-3 text-white right-3 sm:text-xl md:text-2xl">
        <Link href="/events" className="inline-block mx-4 md:mx-10 hover:font-black hover:shadow-2xl hover:scale-110">Events</Link>
        <Link href="/about" className="inline-block mx-4 md:mx-10 hover:font-black hover:shadow-2xl hover:scale-110">About</Link>
        <img
